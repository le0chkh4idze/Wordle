document.addEventListener('DOMContentLoaded', () => {
    const WORD_LIST = [
        { word: "პერიოდი", hint: "მენდელეევის პერიოდული სისტემა."},
        { word: "გოგირდი", hint: "მენდელეევის პერიოდული სისტემის ელემენტი."},
        { word: "ინდექსი", hint: "ქიმიურ რეაქციაში შემავალი ელემენტების ერთ-ერთი მახასიათებელი."},
        { word: "ფოსფორი", hint: "მენდელეევის პერიოდული სისტემის ელემენტი."},
        { word: "პროტონი", hint: "ატომის აღნაგობა."},
        { word: "ნუკლონი", hint: "ატომის აღნაგობა(კერძოდ ბირთვი)"},
        { word: "იზოტოპი", hint: "ატომთა ტიპი(როგორიცაა იონი)"},
    ];
